...
# アイテムがドロップしたときの処理
  $execute if entity @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{"InfiniteEnderChest.GUI.Item": {id:"GUI.Next"}}}}}] run item replace entity @s enderchest.26 with arrow[custom_data={InfiniteEnderChest.GUI.Item: {id:"GUI.Next"}}, item_name='{"text": "次のページ"}', lore=['{"text": "($(ender_chest_current_page)/$(ender_chest_max_page))","italic": false, "color": "gray"}']] 1
  $execute if entity @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{"InfiniteEnderChest.GUI.Item": {id:"GUI.Previous"}}}}}] run item replace entity @s enderchest.8 with arrow[custom_data={InfiniteEnderChest.GUI.Item: {id:"GUI.Previous"}}, item_name='{"text": "前のページ"}', lore=['{"text": "($(ender_chest_current_page)/$(ender_chest_max_page))","italic": false, "color": "gray"}']] 1
  execute if entity @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{"InfiniteEnderChest.GUI.Item": {id:"GUI.Placeholder"}}}}}] run item replace entity @s enderchest.17 with black_stained_glass_pane[custom_data={InfiniteEnderChest.GUI.Item: {id:"GUI.Placeholder"}}, hide_tooltip={}] 1
  execute if score @s InfiniteEnderChest.Page >= @s InfiniteEnderChest.MaxPage if entity @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{"InfiniteEnderChest.GUI.Item": {id:"GUI.End"}}}}}] run item replace entity @s enderchest.26 with black_stained_glass_pane[custom_data={InfiniteEnderChest.GUI.Item: {id:"GUI.End"}}, hide_tooltip={}] 1
  execute if score @s InfiniteEnderChest.Page matches ..1 if entity @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{"InfiniteEnderChest.GUI.Item": {id:"GUI.End"}}}}}] run item replace entity @s enderchest.8 with black_stained_glass_pane[custom_data={InfiniteEnderChest.GUI.Item: {id:"GUI.End"}}, hide_tooltip={}] 1
